module.exports = {
  openapi: '3.0.3',
  info: { title: 'Preview Service API', version: '1.0.0' },
  paths: {
    ...
    '/api/preview-service/process': { post: { summary: 'Process service payload', responses: { 200: { description: 'Processed' }, 400: { description: 'Validation error' } } } }
  }
};
