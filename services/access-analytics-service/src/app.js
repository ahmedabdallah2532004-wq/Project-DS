...
client.collectDefaultMetrics({ register, prefix: 'access_analytics_service_' });
const httpRequestsTotal = new client.Counter({
  name: 'access_analytics_service_http_requests_total',
  help: 'Total HTTP requests.',
  labelNames: ['method', 'path', 'status_code'],
  registers: [register]
});
const httpRequestDuration = new client.Histogram({
  name: 'access_analytics_service_http_request_duration_seconds',
...
app.post('/api/access-analytics-service/process', (req, res, next) => {
  try {
