...
function log(level, message, metadata = {}) {
  process.stdout.write(`${JSON.stringify({
    ...
    service: 'webhook-service-smoke-test',
...
async function main() {
  ...
  log('info', 'Smoke test passed: manual route, Kafka route, webhook delivery, retries/log schema, and MongoDB logging are working.');
}
