...
client.collectDefaultMetrics({ register, prefix: 'backup_service_' });
...
const httpRequestDuration = new client.Histogram({
  name: 'backup_service_http_request_duration_seconds',
...
app.post('/api/backup-service/process', (req, res, next) => {
  try {
