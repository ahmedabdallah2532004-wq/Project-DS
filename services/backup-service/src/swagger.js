module.exports = {
  openapi: '3.0.3',
  info: { title: 'Backup Service API', version: '1.0.0' },
  paths: {
    ...
    '/api/backup-service/process': { post: { summary: 'Process service payload', responses: { 200: { description: 'Processed' }, 400: { description: 'Validation error' } } } }
  }
};
