...
client.collectDefaultMetrics({ register, prefix: 'metrics_service_' });
const httpRequestsTotal = new client.Counter({
  name: 'metrics_service_http_requests_total',
...
app.post('/api/metrics-service/process', (req, res, next) => {
  try {
